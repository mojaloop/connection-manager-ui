...
let
  k3d = nixpkgs.stdenv.mkDerivation rec {
    ...
    src = builtins.fetchurl {
      ...
      sha256 = "0xm1qsm7rn4kl4rqhliz2kgq4vkdins5qlszy512czf9fh6d8xc0";  # Replace with the correct SHA256
    };
  ...
  skaffold = nixpkgs.stdenv.mkDerivation rec {
    ...
    src = builtins.fetchurl {
      ...
      sha256 = "1lky6fpnymspw4cgz2csxjcs3yzcsxg93f6hqhz7370r1ghmi57i";  # Replace with the correct SHA256
    };
    dontUnpack = true;
    installPhase = ''
      mkdir -p $out/bin
